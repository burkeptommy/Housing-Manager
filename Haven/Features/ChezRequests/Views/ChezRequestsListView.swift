        ...
        VStack(spacing: 16) {
            ...
            VStack(spacing: 8) {
                Text("Need a hand?")
                    ...
                    .foregroundStyle(HavenColors.textPrimary)
                Text("Whenever you're finding a vendor, getting a quote, scheduling a visit, or coordinating a task — tap the \"Have a Chez Home Manager handle this\" button anywhere in the app, and Tom takes it from there.")
