...
import { Card, Badge, SkeletonList, NoDocumentsEmptyState, ErrorEmptyState, ScreenContainer } from '../../../src/components';
...
export default function VaultScreen() {
  ...
  if (isLoading) {
    return (
      <ScreenContainer title="Documents" onBackPress={() => router.navigate('/more')} scrollable={false}>
        <ScrollView
          horizontal
  ...
  if (error && documents.length === 0) {
    return (
      <ScreenContainer title="Documents" onBackPress={() => router.navigate('/more')}>
