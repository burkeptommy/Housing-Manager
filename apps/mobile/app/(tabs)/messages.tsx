...
// Demo contacts for new message picker
const DEMO_CONTACTS: Contact[] = [
  { id: 'sarah', name: 'Sarah Chen', role: 'Your Home Manager', category: 'team', isOnline: true, isPinned: true },
  { id: 'marcus', name: 'Marcus Johnson', role: 'Your Handyman', category: 'team', isOnline: false, isPinned: true },
  { id: 'concierge', name: 'Haven Concierge', role: 'AI Assistant', category: 'team', isOnline: true, isPinned: true },
...
export default function MessagesScreen() {
  ...
  const handleContactSelect = (contact: Contact) => {
    ...
    router.push('/(tabs)/sarah/chat' as any);
  };
          ...
          <FlatList
            ...
            ListHeaderComponent={
              <>
                ...
                {DEMO_CONTACTS.filter(c => c.category === 'team').map(contact => (
                  <TouchableOpacity
                    key={contact.id}
                    style={styles.contactItem}
                ...
                {DEMO_CONTACTS.filter(c => c.category === 'vendors').map(contact => (
                  <TouchableOpacity
                    key={contact.id}
                    style={styles.contactItem}
                    onPress={() => handleContactSelect(contact)}
