...
export function AlfredLogo({ size = 40, variant = 'light' }: AlfredLogoProps) {
  const houseColor = variant === 'light' ? '#0a1929' : '#ffffff';
  const champagne = '#c4a574';
  const cutoutColor = '#0a1929';
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 120 120" fill="none">
      ...
      {/* Inner warmth - Champagne */}
      <Path d="M60 51L77 89H43L60 51Z" fill={champagne} />
      ...
      <Path d="M93 27L95.5 33.5L102 36L95.5 38.5L93 45L90.5 38.5L84 36L90.5 33.5L93 27Z" fill={champagne} />
      ...
      {/* Tiny accent dots */}
      <Circle cx={99} cy={42} r={1.5} fill={champagne} opacity={variant === 'light' ? 0.4 : 0.5} />
      <Circle cx={23} cy={51} r={1.5} fill={champagne} opacity={variant === 'light' ? 0.4 : 0.5} />
    </Svg>
  );
}
