...
import { Card, Badge, LoadingSpinner, Button } from '../components';
...
// =============================================================================
// SARAH MANAGER SCREEN (Premium Tier)
// =============================================================================

export function SarahManagerScreen() {
  ...
  const [managerPhone] = useState('+1 (555) 123-4567');
      ...
      >
        ...
        <Card style={styles.managerCard}>
          <View style={styles.managerHeader}>
            <View style={styles.managerAvatar}>
              <Text style={styles.managerInitials}>{getInitials(managerInfo.name)}</Text>
            </View>
            <View style={styles.managerInfo}>
              <Text style={styles.managerName}>{managerInfo.name}</Text>
              <Text style={styles.managerRole}>{managerInfo.title}</Text>
            </View>
        ...
        {activeRequests.length > 0 && (
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              ...
              <TouchableOpacity onPress={() => router.push('/(tabs)/manager/requests' as any)}>
                <Text style={styles.seeAllText}>See All</Text>
              </TouchableOpacity>
            </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.quickActions}>
            ...
            <TouchableOpacity
              style={styles.quickActionCard}
              onPress={() => router.push('/(tabs)/manager/requests' as any)}
            >
              <View style={styles.quickActionIcon}>
