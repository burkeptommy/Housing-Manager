    ...
    <header className="lg:hidden sticky top-0 z-40 bg-white border-b border-neutral-200">
      <div className="flex items-center justify-between h-14 px-4">
        ...
        <div ref={householdMenuRef} className="relative">
          ...
          {householdMenuOpen && (
            <div className="absolute left-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-neutral-200 py-1 z-50">
              {households.length > 0 ? (
                ...
                <div className="px-4 py-3 text-sm text-neutral-500">No homes yet</div>
              )}
            </div>
          )}
        </div>
        ...
        {/* Page Title */}
        <h1 className="absolute left-1/2 -translate-x-1/2 text-base font-bold tracking-tight text-neutral-900">
          {pageTitle}
        </h1>
            ...
            {userMenuOpen && (
              <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-neutral-200 py-1 z-50">
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-red-600 hover:bg-neutral-50"
                >
