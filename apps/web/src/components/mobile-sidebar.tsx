...
const navigation: NavItem[] = [
  ...
  { name: 'Community', href: '/app/community', icon: <Users className="w-5 h-5" /> },
  ...
  { name: 'Concierge', href: '/app/concierge', icon: <Sparkles className="w-5 h-5" /> },
  { name: 'My Jobs', href: '/app/handyman', icon: <Settings className="w-5 h-5" />, roles: ['HANDYMAN'] },
  { name: 'Support', href: '/app/support', icon: <MessageSquare className="w-5 h-5" /> },
