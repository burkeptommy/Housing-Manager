...
export function SkipToHumanBanner() {
  return (
    <div className="bg-haven-50 border border-haven-200 rounded-xl p-4 mb-8">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <p className="text-sm text-haven-900 font-medium">
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-2 mt-3">
            <Link
              ...
              className="text-sm font-medium text-haven-700 hover:text-haven-800"
            >
              Schedule call →
            </Link>
            <Link
            ...
            <a
              ...
              className="text-sm font-medium text-haven-700 hover:text-haven-800 flex items-center gap-1"
            >
