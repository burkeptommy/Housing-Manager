    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-haven-700 text-white mb-4">
            <svg
              className="w-8 h-8"
              fill="none"
              stroke="currentColor"
        ...
        <div className="card">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-slate-600 dark:text-slate-400">
              ...
              <Link
                href="/register"
                className="font-medium text-haven-700 hover:text-haven-800 dark:text-haven-400"
              >
                Create one
              </Link>
            </p>
