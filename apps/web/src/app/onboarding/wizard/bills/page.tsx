    ...
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="text-center mb-8">
        <div className="w-14 h-14 bg-haven-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
          <Receipt className="w-7 h-7 text-haven-600" />
        </div>
        <h1 className="text-2xl font-bold text-haven-900 mb-2">Your bills & accounts</h1>
      ...
      {data.bills.length > 0 && (
        <div className="bg-haven-900 text-white rounded-2xl p-6 mb-6">
            ...
            >
              ...
              >
                <div className="flex items-center gap-3">
                  <h3 className="font-semibold text-haven-900">{group.name}</h3>
                  {hasEntries && (
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="font-medium text-haven-900">{bill.provider}</p>
      ...
      <button
        ...
        className="w-full mt-6 py-4 px-6 border-2 border-dashed border-gray-200 rounded-2xl text-gray-500 hover:border-haven-500 hover:text-haven-600 transition-colors flex items-center justify-center gap-2"
      >
            ...
            {selectedCategory && (
              <div className="sticky bottom-0 bg-white border-t border-gray-200 px-6 py-4 flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-3 px-4 bg-haven-900 text-white rounded-xl font-medium hover:bg-haven-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
