...
const MOCK_VEHICLES: VehicleMember[] = [
  ...
  },
  {
    ...
    primaryDriverId: 'a2',
    primaryDriverName: 'Alice Thompson',
    currentMileage: 8750,
    mileageUpdatedAt: getDate(-7),
    annualMiles: 10000,
    registrationExpiry: getDate(250),
    registrationState: 'CT',
    insuranceProvider: 'Chubb',
    insurancePolicyNum: 'AUTO-887429-03',
    insuranceExpiry: getDate(250),
    ...
    loanBalance: 68000,
    loanMaturityDate: new Date(2027, 8, 1),
    lastOilChange: getDate(-105),
    oilChangeMileage: 5000,
    nextServiceDue: getDate(260),
    nextServiceMileage: 15000,
    preferredServiceShop: 'Mercedes-Benz of Greenwich',
    serviceHistory: [
      { id: 's6', serviceType: 'First Service', date: getDate(-105), mileage: 5000, cost: 0, shop: 'Mercedes-Benz of Greenwich', notes: 'Included with lease' },
    ],
  },
];
