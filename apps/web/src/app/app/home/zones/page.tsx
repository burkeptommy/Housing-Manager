    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-xl font-bold text-haven-900">Your Home</h1>
      ...
      {zones.length === 0 ? (
        ...
        <div className="max-w-2xl mx-auto px-4 py-16 text-center">
          <div className="w-20 h-20 bg-haven-100 rounded-2xl flex items-center justify-center mx-auto mb-6">
            <Home className="w-10 h-10 text-haven-600" />
          </div>
          <h2 className="text-2xl font-bold text-haven-900 mb-3">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 text-left max-w-md mx-auto">
            <h3 className="font-semibold text-haven-900 mb-4">What to expect:</h3>
            ...
            <div className="col-span-8">
              {selectedZone ? (
                <div className="bg-white rounded-xl border border-gray-200">
                  ...
                  {/* Assets List */}
                  <div className="p-6">
                    <h3 className="font-semibold text-haven-900 mb-4">Items in {selectedZone.name}</h3>
                  ...
                  {selectedZone.procedures && (
                    <div className="p-6 border-t border-gray-100 bg-gray-50">
                      <h3 className="font-semibold text-haven-900 mb-3">Care Instructions</h3>
