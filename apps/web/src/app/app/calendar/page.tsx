    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
      <div className="bg-white rounded-2xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6 border-b border-slate-200">
          ...
          {selectedDate && (
            <p className="text-sm text-slate-500 mt-1">{formatDateLong(selectedDate)}</p>
          )}
        </div>
          ...
          {!eventType ? (
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full flex items-center gap-4 p-4 border border-slate-200 rounded-xl hover:border-emerald-300 hover:bg-emerald-50/50 transition-colors text-left"
              >
                <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center">
                  <Users className="w-6 h-6 text-blue-600" />
                </div>
                <div>
                  <p className="font-medium text-slate-900">Family Event</p>
                  <p className="text-sm text-slate-500">Sports, parties, appointments, travel</p>
                </div>
              </button>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {['Never', 'Weekly', 'Bi-Weekly', 'Monthly'].map((option) => (
                    <button
                      key={option}
                      className="px-4 py-2 border border-slate-200 rounded-lg text-sm text-slate-600 hover:border-emerald-300 hover:bg-emerald-50 transition-colors"
                    >
                      {option}
                    </button>
                  ))}
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {mockFamilyMembers.map((member) => (
                    <button
                      key={member.id}
                      className="flex items-center gap-2 px-3 py-2 border border-slate-200 rounded-lg text-sm text-slate-600 hover:border-emerald-300 hover:bg-emerald-50 transition-colors"
                    >
  ...
  return (
    <div className="space-y-6 pb-24 lg:pb-6">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      ...
                      {dayEvents.length > 3 && (
                        <p className="text-xs text-slate-500 pl-1">+{dayEvents.length - 3} more</p>
                      )}
                    </div>
                  </div>
                );
      ...
      <button
        ...
        className="fixed bottom-20 right-4 lg:bottom-6 lg:right-6 w-14 h-14 bg-emerald-600 text-white rounded-full shadow-lg hover:bg-emerald-700 hover:shadow-xl transition-all flex items-center justify-center z-40"
      >
