      ...
      <tr>
        <td align="center" style="padding:48px 16px;">
          <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width:560px;background:#FFFFFF;border-radius:16px;border:1px solid #EDEEF0;">
            ...
            <tr><td style="padding:32px 32px 0 32px;font-family:-apple-system,BlinkMacSystemFont,'SF Pro',Helvetica,Arial,sans-serif;font-size:12px;line-height:1.6;color:#6B6B7B;text-align:center;">This invite expires in 30 days. If you don't want to join, just ignore this email.</td></tr>
...
async function loadInvitationContext(supabase: any, invitationId: string): Promise<EmailContext | { error: string; status: number }> {
  ...
  return {
    ...
    inviteUrl: `https://getchez.com/join/${invitation.invite_code}`,
