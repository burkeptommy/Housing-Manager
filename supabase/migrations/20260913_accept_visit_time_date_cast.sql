-- Phase 75d: maintenance_tasks.scheduled_date and .next_due_date are
-- DATE columns; my last RPC revision wrote to_char(...) which returns
-- TEXT and Postgres rejected it (42804 invalid_text_representation).
-- Pass the date value directly.
...
begin
    ...
    -- maintenance_tasks.scheduled_date and .next_due_date are DATE
    -- columns; pass the date value directly (was to_char text before).
